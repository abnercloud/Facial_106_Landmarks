...
class InferenNet_fast(nn.Module):
    def __init__(self, kernel_size, dataset):
        ...
        print('Loading pose model from {}'.format('./train_sppe/exp/coco/v100_exp2/model_63.pkl'))
        sys.stdout.flush()
        model.load_state_dict(torch.load('./train_sppe/exp/coco/v100_exp2/model_63.pkl'))
        model.eval()
        self.pyranet = model
...
class InferenNet_fast_old(nn.Module):
    def __init__(self, kernel_size, dataset):
        super(InferenNet_fast, self).__init__()

...
class Mscoco(data.Dataset):
    def __init__(self, train=True, sigma=1,
        ...
        self.img_folder = '../hand21_data/copy/'    # root image folders
        ...
        with h5py.File('../hand21_data/mount/handpose_data.h5', 'r') as annot:
            # train
            self.imgname_coco_train = annot['imgname'][:160000]
            self.bndbox_coco_train = annot['bndbox'][:160000]
            self.part_coco_train = annot['part'][:160000]
            # val
            self.imgname_coco_val = annot['imgname'][160000:180000]
            self.bndbox_coco_val = annot['bndbox'][160000:180000]
            self.part_coco_val = annot['part'][160000:180000]
